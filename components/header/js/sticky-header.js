...
function toggleClassHeader() {
    ...
    if (isMobile === false) {
        currentScroll > 42 ? header.classList.add(newClassHeader) : header.classList.remove(newClassHeader);
    } else {
...
function toggleClassMain() {
    const currentScroll = getCurrentScroll();
    if (isMobile === false) {
        currentScroll > 42 ? main.classList.add(newClassMain) : main.classList.remove(newClassMain);
    } else {
